<?php 
    ...
    $order_query = $conn->query("SELECT * FROM orders JOIN pickup_location on orders.pickup_location_id = pickup_location.id JOIN book on book.book_id = orders.book_id JOIN student on student.student_id = orders.student_id WHERE status = 1 ORDER BY order_id DESC");
?>
<!DOCTYPE html>
