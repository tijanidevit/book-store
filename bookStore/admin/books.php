<?php 
    ...
    $book_query = $conn->query("SELECT * FROM book JOIN department ON department.department_id = book.dept_id ORDER BY book_id DESC");
?>
<!DOCTYPE html>
                                            ...
                                            <div class="card-block card-dashboard">
                                                ...
                                                <div id="table-container" style="display:none" class="table-responsive">
                                                    <table class="table table-striped table-bordered file-export" id="table-el">
                                                        ...
                                                        <tbody id="table-body">
                                                            <?php $sn = 0; while ($book = $book_query->fetch_assoc()): $sn++; ?>
                                                                <tr>
                                                                    <td><?php echo $sn ?></td>
                                                                    ...
                                                                    <td><a href="update-book-qty?id=<?php echo $book['book_id'] ?>" class="btn btn-sm btn-primary">Update Qty</a></td>
                                                                </tr>
                                                            <?php endwhile ?>
                                                        </tbody>
                                                        <tfoot>
